...
def ask():
    ...
    if ask_val is not None:
        ...
        # Handle case where ask_val is None
        # For example, display a message to the user or retry speech recognition
        text.insert(END, "Unable to recognize speech. Please try again.\n")
...
# Image
Display_Image = ImageTk.PhotoImage(Image.open("face.jpg"))
